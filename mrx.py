...
logo = """
    __  __ ___ __  __
 |  \/  | _ \\ \/ / *au : HA-MRX
 | |\/| |   / >  <  *fb : fb.com/z.venom.xy
 |_|  |_|_|_\/_/\_\*gh : github.com/HA-MRX
                     FB GROUP : fb.com/groups/995348314618474/
"""
ips=None
try:
...
class crack2:
	...
	def main(self,fl):
		try:
			...
			self.ko+=1
			print "\r *Crack %s/%s *TryNow : %s - *MRX-Cp : %s"%(self.ko,len(self.fl),len(self.ada),len(self.cp)),;sys.stdout.flush()
		except:
			self.main(fl)
